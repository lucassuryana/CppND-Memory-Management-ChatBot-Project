...
private:
    ...
    std::unique_ptr<ChatLogic> _chatLogic; // this line of code creates a unique pointer to a ChatLogic object
    // ChatLogic *_chatLogic; // template
...
public:
    ...
    // ChatLogic *GetChatLogicHandle() { return _chatLogic; } // template
